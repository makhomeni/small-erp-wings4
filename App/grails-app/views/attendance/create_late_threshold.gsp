...
<%@ page import="com.jabait.hrm.time.LateThreshold; com.jabait.hrm.JobRole"%>
<%@ page contentType="text/html;charset=UTF-8" %>

<g:applyLayout name="app">
    <head>
        <g:set var="entityName" value="${message(code:'configuration.description', default: 'Late Threshold')}"/>
...
//                alert(liveValidation)
            ...
            function submitForm(){
                document.thresholdTypeForm.submit();
            }
        </script>
    ...
    <content tag="rightTag">
        ...
        <div class="bread_crumbs_ui_div" style="width: 611px">
            <ul id="crumbs_ui_custom">
                ...
                <li><g:link controller="attendance" action="lateThresholdList">Late Threshold List</g:link></li>
                <li>Threshold Create</li>
            </ul>
        </div>
        <br class="clear"/>
        ...
        <div class="widget">
            ...
            <g:form name="thresholdTypeForm" id="thresholdTypeForm" controller="attendance" action="saveThresholdType" method="POST">

                <fieldset class="lateThreshold">
                    <div class="grid_8">
                        <div class="grid_4 alpha">
                            <label for="lateThreshold">
                                <g:message code="lateThreshold.label" default="Threshold Type" />
                        ...
                        <div class="grid_4 omega">
                            <select name="thresholdType">
                                ...
                                <option value="absent_late">Absent Due to Late</option>
                    ...
                    <div class="grid_8">
                        <div class="fieldcontain ${hasErrors(bean: lateThresholdInstance, field: 'lateThreshold', 'error')} required">
                            <div class="grid_4 alpha">
                                <label for="lateThreshold">
                                    <g:message code="lateThreshold.label" default="Late Threshold" />
                                    %{--<span class="required-indicator">*</span>--}%
                                </label>
                            </div>
                            <div class="grid_4 omega">
                                <g:textField name="lateThreshold" required=""  value="" />
                            </div>
                    ...
                    <div class="grid_4 omega" style="padding-left: 194px;padding-top: 15px">
                        ...
                        <a id="ff" class="button danger icon remove" onclick="document.thresholdTypeForm.reset()">Clear</a>
