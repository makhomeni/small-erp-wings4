    ...
    <content tag="rightTag">
        ...
        <div class="widget">
            ...
            <div id="list_user" class="content scaffold-list" role="main" style="width: 800px;">
                <ul class="widgetlist">
                    <li><g:link controller="payroll" action="advancePayRegisterList"><img src="${resource(dir:'images/assets/icons', file: 'advance.png')}" alt="Document Icon"><span>Advance</span></g:link></li>
                    <li><g:link controller="payroll" action="payRegisterList"><img src="${resource(dir:'images/assets/icons', file: 'payroll.png')}" alt="Document Icon"><span>Payroll</span></g:link></li>
                </ul>
            </div>
        </div>
    </content>
