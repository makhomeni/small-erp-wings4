...
public class LookAndFeelManager{
    ...
    public static void setSystemLookAndFeel(){
        setLookAndFeel(UIManager.getSystemLookAndFeelClassName(),
                JLiteStyle.ID, FlatButtonUI.ID, FlatMenuButtonUI.ID, FlatSplitButtonUI.ID, JFlatButtonStyle.ID);
    }
    ...
    public static void setMetalLookAndFeel(){
        setLookAndFeel("javax.swing.plaf.metal.MetalLookAndFeel", JLiteStyle.ID,
                FlatButtonUI.ID, FlatMenuButtonUI.ID, FlatSplitButtonUI.ID, JFlatButtonStyle.ID);
    }
    ...
    public static void setWindowsLookAndFeel(){
        setLookAndFeel("com.sun.java.swing.plaf.windows.WindowsLookAndFeel",
                JWindowsStyle.ID, FlatButtonUI.ID, FlatMenuButtonUI.ID, FlatSplitButtonUI.ID, JFlatButtonStyle.ID);
    }
    ...
    public static void setNimbusLookAndFeel(){
        setLookAndFeel("com.sun.java.swing.plaf.nimbus.NimbusLookAndFeel",
                JNimbusStyle.ID, LiteButtonUI.ID, LiteMenuButtonUI.ID, LiteSplitButtonUI.ID, JNimbusLiteButtonStyle.ID);
    }
    ...
    public static void setAlloyLookAndFeel(){
        setLookAndFeel("com.incors.plaf.alloy.DefaultThemeAlloyLookAndFeel",
                JLiteStyle.ID, LiteButtonUI.ID, LiteMenuButtonUI.ID, LiteSplitButtonUI.ID, JAlloyLiteButtonStyle.ID);
    }
    ...
    public static void setAcidLookAndFeel(){
        setLookAndFeel("com.incors.plaf.alloy.AcidThemeAlloyLookAndFeel",
                JLiteStyle.ID, LiteButtonUI.ID, LiteMenuButtonUI.ID, LiteSplitButtonUI.ID, JAcidLiteButtonStyle.ID);
    }
    ...
    public static void setBedouinLookAndFeel(){
        setLookAndFeel("com.incors.plaf.alloy.BedouinThemeAlloyLookAndFeel",
                JLiteStyle.ID, LiteButtonUI.ID, LiteMenuButtonUI.ID, LiteSplitButtonUI.ID, JBedouinLiteButtonStyle.ID);
    }
    ...
    public static void setGlassLookAndFeel(){
        setLookAndFeel("com.incors.plaf.alloy.GlassThemeAlloyLookAndFeel",
                JLiteStyle.ID, LiteButtonUI.ID, LiteMenuButtonUI.ID, LiteSplitButtonUI.ID, JGlassLiteButtonStyle.ID);
    }
    ...
    public static void setBorlandLookAndFeel(){
        setLookAndFeel("com.borland.plaf.borland.BorlandLookAndFeel",
                JWindowsStyle.ID, LiteButtonUI.ID, LiteMenuButtonUI.ID, LiteSplitButtonUI.ID, JBorlandLiteButtonStyle.ID);
    }
    ...
    public static void setJGoodiesWindowsLookAndFeel(){
        setLookAndFeel("com.jgoodies.looks.windows.WindowsLookAndFeel",
                JWindowsStyle.ID, LiteButtonUI.ID, LiteMenuButtonUI.ID, LiteSplitButtonUI.ID, JEclipseLiteButtonStyle.ID);
    }
     ...
     */
    public static void setLookAndFeel(String lookAndFeel, String style, String buttonUI,
                                      String menuButtonUI, String splitButtonUI, String buttonStyle){
        try{
            UIManager.setLookAndFeel(lookAndFeel);
        } catch (Exception e){
    ...
    public static void invokeLookAndFeel(String lookAndFeel){
        try{
            Class.forName("com.nepxion.swing.lookandfeel.LookAndFeelManager").
                    getMethod("set" + lookAndFeel, null).invoke(null, null);
     ...
     */
    public static void setButtonUI(String buttonUIClass, String menuButtonUIClass,
                                   String splitButtonUIClass, String buttonStyleClass){
