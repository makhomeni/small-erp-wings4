...
Ext.ux.calendar.Mask = {
    ...
    'CalendarContainer':{
        ...
        'moreMenu.about.text':'About JABA IT MyCalendar',
        'moreBtn.text':'More',
    ...
    colors:['668CD9', 'D96666', '59BFB3', 'F2A442', '4CB052', 'B373B3', '000000' ,'8A4117'],

    colorIndex:["blue", "red", "cyan", "orange", "green", "purple", "black", "sienna"],
