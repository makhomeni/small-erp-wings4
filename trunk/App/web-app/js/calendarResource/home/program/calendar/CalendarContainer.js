...
Ext.ux.calendar.CalendarContainer = function(config){
    ...
    Ext.ux.calendar.CalendarContainer.superclass.constructor.call(this, {
        ...
        tbar:[
            ...
            this.refreshBtn, '-', this.dayBtn,  '-', this.monthBtn, '-', this.moreBtn
        ]
    });    
    this.addEvents(
        'refresh',
...
Ext.extend(Ext.ux.calendar.CalendarContainer, Ext.Panel, {
    ...
    onAboutMyCalendarFn : function(){
        ...
        '    <span style="font-size:16px;"><b>OceanGroup Calendar</b></span><br/>' +
        '    <font color="grey">Version 2.1.0</font>' +
        '    <br/><br/>' +
        '    Copyright &copy; 2012-2013 OceanGroup Inc. All right reserved<br/>' +
        '    <a href="http://www.jabait.com/" target="_blank">http://www.jabait.com/</a><br/><br/>' +
        '</div>' +
        '<div style="clear:left;padding:0 20px 20px;">' +
        '    To query license information, please vist our site or ' +
        '    send the email to: <a href="mailto:hossaindoula@gmail.com">hossaindoula@gmail.com</a>.' +
        '    <br><br><hr>' +
