    ...
    <content tag="rightTag">
        ...
        <div class="widget">
            ...
            <div class="header" style="width: 849px;">
                <span><span class="ico gray attendance"></span>Attendance Configuration Home</span>
            </div>
            ...
            <div id="list_user" class="content scaffold-list" role="main" style="width: 800px;">
                <ul class="widgetlist">
                    <li><g:link controller="attendance" action="lateThresholdList"><img src="${resource(dir:'images/assets/icons', file: 'leave_threshold.png')}" alt="Document Icon"><span>Late Threshold</span></g:link></li>
                    <li><g:link controller="attendance" action="attendanceAdjustmentList"><img src="${resource(dir:'images/assets/icons', file: 'adjustment_threshold.png')}" alt="Document Icon"><span>Adjustment Threshold</span></g:link></li>
                </ul>
            </div>
        </div>
    </content>
