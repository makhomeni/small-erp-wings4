    ...
    <content tag="rightTag">
        ...
        <div class="widget">
            ...
            <div id="list_user" class="content scaffold-list" role="main" style="width: 765px;">
                <ul class="widgetlist">
                    <li><g:link controller="leave" action="leaveList"><img src="${resource(dir:'images/assets/icons', file: 'leave_request.png')}" alt="Leave Icon"><span>Leave Request</span></g:link></li>
                    <li><g:link controller="leave" action="waiverList"><img src="${resource(dir:'images/assets/icons', file: 'lateWaiver.gif')}" alt="Leave Icon"><span>Late Waiver</span></g:link></li>
                    <li><g:link controller="leave" action="advanceWaiverList"><img src="${resource(dir:'images/assets/icons', file: 'lateWaiver.gif')}" alt="Leave Icon"><span>Advance Late Waiver</span></g:link></li>
                </ul>
            </div>
        </div>
    </content>
