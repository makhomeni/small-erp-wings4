...
//                        alert(record.get('waiverStatus'))
            ...
            tbar: [{
                xtype: "button",
                text: "Add Advance Waiver Request",
                iconCls: "addRecord" ,
                handler:function(){
                    window.location="${createLink(controller: 'leave',action: 'advanceWaiverRequest')}"
                }
            }]
        });
            ...
            buttons:[
                {
                    ...
                    handler: function(){
                        ...
                        approveForm.getForm().submit({
                            url:'${createLink(controller: "leave",action: "advanceWaiverAction")}',
                            params: {
                                userId: userId,
