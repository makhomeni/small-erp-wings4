    ...
    <content tag="rightTag">
        ...
        <div class="widget">
            ...
            <div id="list_user" class="content scaffold-list" role="main" style="width: 765px;">
                <ul class="widgetlist">
                    <li><g:link controller="calendar" action="systemCalendar"><img src="${resource(dir:'images/assets/icons', file: 'sys_calendar.png')}" alt="Document Icon"><span>System Calendar</span></g:link></li>
                    <li><g:link controller="calendar" action="organizationCalendar"><img src="${resource(dir:'images/assets/icons', file: 'org_calendar.png')}" alt="Document Icon"><span>Organization Calendar</span></g:link></li>
                    <li><g:link controller="calendar" action="employeeCalendar"><img src="${resource(dir:'images/assets/icons', file: 'emp_calender.png')}" alt="Document Icon"><span>Employee Calendar</span></g:link></li>
                </ul>
            </div>
        </div>
    </content>
