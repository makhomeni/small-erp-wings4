...
public class CategoryCreate extends JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1 = new JLabel();
        parentCategory = new JComboBox();
        submitCategory = new JButton();
        cancelCategory = new JButton();
//
//        setClosable(true);
...
//        setTitle("CategoryCreate");
        ...
        parentCategory.setModel(new DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
...
//        pack();
    ...
    private JButton cancelCategory;
    private JLabel categoryNameLabel;
    private JTextField categoryNameText;
    private JLabel jLabel1;
    private JComboBox parentCategory;
    private JButton submitCategory;
